# Stubs for mersad.test.classical.test_mixalph_cipher (Python 3)
#
...
class TestShiftCipher(unittest.TestCase):
    ...
    def test_encrypt_with_custom_sort_key(self) -> None: ...
    ...
    def test_show_sort_key(self) -> None: ...
    def test_none_key(self) -> None: ...
    def test_sort_key_doesnt_have_all_key_letters(self) -> None: ...
    def test_sort_key_have_more_letters_than_key(self) -> None: ...
